...
%if ret.uid > 18
    % Model info
param_label = 'NonTMS2BiasesTrial';
%else
    %param_label = 'Wide';
%end
% Exp
...
paramBounds = [0.0001, 0.0001, 0.0001, 0.0001, -0.02, -0.02, 0.0061, 0.0061, 1.53, 100, 0.006; ...
                    0.095, 0.095, 0.095, 0.095, 0.045, 0.045, 0.0235, 0.0245, 5.35, 450, 0.01];
%for ibounds = 1:5
